    ...
    return(
        ...
        <li className="li">
         <div>
          ...
          krta hun , avi thoda baitha hun, ghr aake krunga aaram se, thank you, for understanding, aaj maine adi se baat krra busness ke bare let's take a risk and roll, agar chal jata hai business to well and good, and agar ni chalta hai, to back to kam kaaj
          </li>
